...
--
-- Servidor: localhost
-- Tiempo de generación: 26-06-2015 a las 07:06:50
...
CREATE TABLE IF NOT EXISTS `tbl_informe` (
  ...
  KEY `id_trabajador` (`id_trabajador`),
  KEY `id_audio_tonal_od` (`id_audio_tonal_od`),
  KEY `id_audio_tonal_oi` (`id_audio_tonal_oi`),
  KEY `id_diagnostico` (`id_diagnostico`),
  KEY `id_otoscopia` (`id_otoscopia`),
  KEY `id_recomendacion` (`id_recomendacion`),
  KEY `id_experiencia_laboral` (`id_experiencia_laboral`),
  KEY `id_linea_base` (`id_linea_base`),
  KEY `id_empresa` (`id_empresa`),
  KEY `id_menoscabo` (`id_menoscabo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `tbl_otoscopia` (
  ...
  KEY `fecha_audiometria` (`fecha_audiometria`),
  KEY `id_trabajador` (`id_trabajador`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
